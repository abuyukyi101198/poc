...
export const nodes = [
  ...
  // ---- R3 Tier-2 / Spine ----
  { id: "spine-data-1", ring: "R3", label: "Data Spine 1", weight: 35, plane: "data", leaf_role: "n/a", trust_tier: "operator", failure_domain_role: "n/a", metadata: { role: "spine" } },
  { id: "spine-data-2", ring: "R3", label: "Data Spine 2", weight: 35, plane: "data", leaf_role: "n/a", trust_tier: "operator", failure_domain_role: "n/a", metadata: { role: "spine" } },
  { id: "spine-mgmt-1", ring: "R3", label: "Mgmt Spine 1", weight: 35, plane: "mgmt", leaf_role: "n/a", trust_tier: "operator", failure_domain_role: "n/a", metadata: { role: "spine" } },
  { id: "spine-mgmt-2", ring: "R3", label: "Mgmt Spine 2", weight: 35, plane: "mgmt", leaf_role: "n/a", trust_tier: "operator", failure_domain_role: "n/a", metadata: { role: "spine" } },

  // ---- R4 Tier-3 / Leaf — data & management access leaves ----
  { id: "leaf-data-1", ring: "R4", label: "Data Leaf 1", weight: 11, plane: "data", leaf_role: "access", trust_tier: "operator", failure_domain_role: "n/a", metadata: { role: "leaf", serves_racks: ["rack-1", "rack-2"] } },
  { id: "leaf-data-2", ring: "R4", label: "Data Leaf 2", weight: 16, plane: "data", leaf_role: "access", trust_tier: "operator", failure_domain_role: "n/a", metadata: { role: "leaf", serves_racks: ["rack-1", "rack-2", "rack-6"] } },
  { id: "leaf-data-3", ring: "R4", label: "Data Leaf 3", weight: 12, plane: "data", leaf_role: "access", trust_tier: "operator", failure_domain_role: "n/a", metadata: { role: "leaf", serves_racks: ["rack-3", "rack-4"] } },
  { id: "leaf-data-4", ring: "R4", label: "Data Leaf 4", weight: 15, plane: "data", leaf_role: "access", trust_tier: "operator", failure_domain_role: "n/a", metadata: { role: "leaf", serves_racks: ["rack-3", "rack-5"] } },

  { id: "leaf-mgmt-1", ring: "R4", label: "Mgmt Leaf 1", weight: 11, plane: "mgmt", leaf_role: "access", trust_tier: "operator", failure_domain_role: "n/a", metadata: { role: "leaf", serves_racks: ["rack-1", "rack-2"] } },
  { id: "leaf-mgmt-2", ring: "R4", label: "Mgmt Leaf 2", weight: 16, plane: "mgmt", leaf_role: "access", trust_tier: "operator", failure_domain_role: "n/a", metadata: { role: "leaf", serves_racks: ["rack-1", "rack-2", "rack-6"] } },
  { id: "leaf-mgmt-3", ring: "R4", label: "Mgmt Leaf 3", weight: 12, plane: "mgmt", leaf_role: "access", trust_tier: "operator", failure_domain_role: "n/a", metadata: { role: "leaf", serves_racks: ["rack-3", "rack-4"] } },
  { id: "leaf-mgmt-4", ring: "R4", label: "Mgmt Leaf 4", weight: 15, plane: "mgmt", leaf_role: "access", trust_tier: "operator", failure_domain_role: "n/a", metadata: { role: "leaf", serves_racks: ["rack-3", "rack-5"] } },
  ...
  { id: "border-leaf-1", ring: "R4", label: "Border Leaf 1", weight: 2, plane: "data", leaf_role: "border", trust_tier: "operator", failure_domain_role: "n/a", metadata: { role: "border_leaf", description: "External/WAN/DCI connectivity — ordinary R4 leaf, distinguished only by leaf_role (spec §7.5)." } },
  { id: "border-leaf-2", ring: "R4", label: "Border Leaf 2", weight: 2, plane: "data", leaf_role: "border", trust_tier: "operator", failure_domain_role: "n/a", metadata: { role: "border_leaf", description: "External/WAN/DCI connectivity — ordinary R4 leaf, distinguished only by leaf_role (spec §7.5)." } },

  // ---- R5 Rack ----
  { id: "rack-1", ring: "R5", label: "Rack 1", weight: 6, plane: "shared", leaf_role: "n/a", trust_tier: "operator", failure_domain_role: "redundant", metadata: { leaf_count: 2, data_leaves: ["leaf-data-1", "leaf-data-2"], mgmt_leaves: ["leaf-mgmt-1", "leaf-mgmt-2"] } },
  { id: "rack-2", ring: "R5", label: "Rack 2", weight: 5, plane: "shared", leaf_role: "n/a", trust_tier: "operator", failure_domain_role: "redundant", metadata: { leaf_count: 2, data_leaves: ["leaf-data-1", "leaf-data-2"], mgmt_leaves: ["leaf-mgmt-1", "leaf-mgmt-2"] } },
  { id: "rack-3", ring: "R5", label: "Rack 3", weight: 8, plane: "shared", leaf_role: "n/a", trust_tier: "operator", failure_domain_role: "redundant", metadata: { leaf_count: 2, data_leaves: ["leaf-data-3", "leaf-data-4"], mgmt_leaves: ["leaf-mgmt-3", "leaf-mgmt-4"], note: "Contains GPU/accelerator nodes." } },
  { id: "rack-4", ring: "R5", label: "Rack 4", weight: 4, plane: "shared", leaf_role: "n/a", trust_tier: "operator", failure_domain_role: "spof", metadata: { leaf_count: 1, data_leaves: ["leaf-data-3"], mgmt_leaves: ["leaf-mgmt-3"], note: "Single-leaf: leaf failure == rack failure." } },
  { id: "rack-5", ring: "R5", label: "Rack 5", weight: 7, plane: "shared", leaf_role: "n/a", trust_tier: "operator", failure_domain_role: "spof", metadata: { leaf_count: 1, data_leaves: ["leaf-data-4"], mgmt_leaves: ["leaf-mgmt-4"], note: "Single-leaf: leaf failure == rack failure." } },
  { id: "rack-6", ring: "R5", label: "Rack 6", weight: 5, plane: "shared", leaf_role: "n/a", trust_tier: "tenant", failure_domain_role: "spof", metadata: { leaf_count: 1, data_leaves: ["leaf-data-2"], mgmt_leaves: ["leaf-mgmt-2"], note: "Single-leaf, tenant-controlled bare-metal servers." } },

  // ---- R6 Server (outermost) ----
  // Rack 1 -- 6 servers
  { id: "server-1-01", ring: "R6", label: "R1-Srv01", weight: 1, plane: "shared", leaf_role: "n/a", trust_tier: "operator", failure_domain_role: "n/a", metadata: { rack: "rack-1" } },
  { id: "server-1-02", ring: "R6", label: "R1-Srv02", weight: 1, plane: "shared", leaf_role: "n/a", trust_tier: "operator", failure_domain_role: "n/a", metadata: { rack: "rack-1" } },
  { id: "server-1-03", ring: "R6", label: "R1-Srv03", weight: 1, plane: "shared", leaf_role: "n/a", trust_tier: "operator", failure_domain_role: "n/a", metadata: { rack: "rack-1" } },
  { id: "server-1-04", ring: "R6", label: "R1-Srv04", weight: 1, plane: "shared", leaf_role: "n/a", trust_tier: "operator", failure_domain_role: "n/a", metadata: { rack: "rack-1" } },
  { id: "server-1-05", ring: "R6", label: "R1-Srv05", weight: 1, plane: "shared", leaf_role: "n/a", trust_tier: "operator", failure_domain_role: "n/a", metadata: { rack: "rack-1" } },
  { id: "server-1-06", ring: "R6", label: "R1-Srv06", weight: 1, plane: "shared", leaf_role: "n/a", trust_tier: "operator", failure_domain_role: "n/a", metadata: { rack: "rack-1" } },

  // Rack 2 -- 5 servers
  { id: "server-2-01", ring: "R6", label: "R2-Srv01", weight: 1, plane: "shared", leaf_role: "n/a", trust_tier: "operator", failure_domain_role: "n/a", metadata: { rack: "rack-2" } },
  { id: "server-2-02", ring: "R6", label: "R2-Srv02", weight: 1, plane: "shared", leaf_role: "n/a", trust_tier: "operator", failure_domain_role: "n/a", metadata: { rack: "rack-2" } },
  { id: "server-2-03", ring: "R6", label: "R2-Srv03", weight: 1, plane: "shared", leaf_role: "n/a", trust_tier: "operator", failure_domain_role: "n/a", metadata: { rack: "rack-2" } },
  { id: "server-2-04", ring: "R6", label: "R2-Srv04", weight: 1, plane: "shared", leaf_role: "n/a", trust_tier: "operator", failure_domain_role: "n/a", metadata: { rack: "rack-2" } },
  { id: "server-2-05", ring: "R6", label: "R2-Srv05", weight: 1, plane: "shared", leaf_role: "n/a", trust_tier: "operator", failure_domain_role: "n/a", metadata: { rack: "rack-2" } },

  // Rack 3 -- 8 servers, including 2 GPU/accelerator nodes
  { id: "server-3-01", ring: "R6", label: "R3-Srv01", weight: 1, plane: "shared", leaf_role: "n/a", trust_tier: "operator", failure_domain_role: "n/a", metadata: { rack: "rack-3" } },
  { id: "server-3-02", ring: "R6", label: "R3-Srv02", weight: 1, plane: "shared", leaf_role: "n/a", trust_tier: "operator", failure_domain_role: "n/a", metadata: { rack: "rack-3" } },
  { id: "server-3-03", ring: "R6", label: "R3-Srv03", weight: 1, plane: "shared", leaf_role: "n/a", trust_tier: "operator", failure_domain_role: "n/a", metadata: { rack: "rack-3" } },
  { id: "server-3-04", ring: "R6", label: "R3-Srv04", weight: 1, plane: "shared", leaf_role: "n/a", trust_tier: "operator", failure_domain_role: "n/a", metadata: { rack: "rack-3" } },
  { id: "server-3-05", ring: "R6", label: "R3-Srv05", weight: 1, plane: "shared", leaf_role: "n/a", trust_tier: "operator", failure_domain_role: "n/a", metadata: { rack: "rack-3" } },
  { id: "server-3-06", ring: "R6", label: "R3-Srv06", weight: 1, plane: "shared", leaf_role: "n/a", trust_tier: "operator", failure_domain_role: "n/a", metadata: { rack: "rack-3" } },
  { id: "server-3-07-gpu", ring: "R6", label: "R3-GPU07", weight: 1, plane: "shared", leaf_role: "n/a", trust_tier: "operator", failure_domain_role: "n/a", metadata: { rack: "rack-3", node_type: "gpu", accelerators: 4 } },
  { id: "server-3-08-gpu", ring: "R6", label: "R3-GPU08", weight: 1, plane: "shared", leaf_role: "n/a", trust_tier: "operator", failure_domain_role: "n/a", metadata: { rack: "rack-3", node_type: "gpu", accelerators: 4 } },

  // Rack 4 -- 4 servers
  { id: "server-4-01", ring: "R6", label: "R4-Srv01", weight: 1, plane: "shared", leaf_role: "n/a", trust_tier: "operator", failure_domain_role: "n/a", metadata: { rack: "rack-4" } },
  { id: "server-4-02", ring: "R6", label: "R4-Srv02", weight: 1, plane: "shared", leaf_role: "n/a", trust_tier: "operator", failure_domain_role: "n/a", metadata: { rack: "rack-4" } },
  { id: "server-4-03", ring: "R6", label: "R4-Srv03", weight: 1, plane: "shared", leaf_role: "n/a", trust_tier: "operator", failure_domain_role: "n/a", metadata: { rack: "rack-4" } },
  { id: "server-4-04", ring: "R6", label: "R4-Srv04", weight: 1, plane: "shared", leaf_role: "n/a", trust_tier: "operator", failure_domain_role: "n/a", metadata: { rack: "rack-4" } },

  // Rack 5 -- 7 servers
  { id: "server-5-01", ring: "R6", label: "R5-Srv01", weight: 1, plane: "shared", leaf_role: "n/a", trust_tier: "operator", failure_domain_role: "n/a", metadata: { rack: "rack-5" } },
  { id: "server-5-02", ring: "R6", label: "R5-Srv02", weight: 1, plane: "shared", leaf_role: "n/a", trust_tier: "operator", failure_domain_role: "n/a", metadata: { rack: "rack-5" } },
  { id: "server-5-03", ring: "R6", label: "R5-Srv03", weight: 1, plane: "shared", leaf_role: "n/a", trust_tier: "operator", failure_domain_role: "n/a", metadata: { rack: "rack-5" } },
  { id: "server-5-04", ring: "R6", label: "R5-Srv04", weight: 1, plane: "shared", leaf_role: "n/a", trust_tier: "operator", failure_domain_role: "n/a", metadata: { rack: "rack-5" } },
  { id: "server-5-05", ring: "R6", label: "R5-Srv05", weight: 1, plane: "shared", leaf_role: "n/a", trust_tier: "operator", failure_domain_role: "n/a", metadata: { rack: "rack-5" } },
  { id: "server-5-06", ring: "R6", label: "R5-Srv06", weight: 1, plane: "shared", leaf_role: "n/a", trust_tier: "operator", failure_domain_role: "n/a", metadata: { rack: "rack-5" } },
  { id: "server-5-07", ring: "R6", label: "R5-Srv07", weight: 1, plane: "shared", leaf_role: "n/a", trust_tier: "operator", failure_domain_role: "n/a", metadata: { rack: "rack-5" } },

  // Rack 6 -- 5 servers, tenant-controlled bare-metal
  { id: "server-6-01", ring: "R6", label: "R6-Srv01", weight: 1, plane: "shared", leaf_role: "n/a", trust_tier: "tenant", failure_domain_role: "n/a", metadata: { rack: "rack-6" } },
  { id: "server-6-02", ring: "R6", label: "R6-Srv02", weight: 1, plane: "shared", leaf_role: "n/a", trust_tier: "tenant", failure_domain_role: "n/a", metadata: { rack: "rack-6" } },
  { id: "server-6-03", ring: "R6", label: "R6-Srv03", weight: 1, plane: "shared", leaf_role: "n/a", trust_tier: "tenant", failure_domain_role: "n/a", metadata: { rack: "rack-6" } },
  { id: "server-6-04", ring: "R6", label: "R6-Srv04", weight: 1, plane: "shared", leaf_role: "n/a", trust_tier: "tenant", failure_domain_role: "n/a", metadata: { rack: "rack-6" } },
  { id: "server-6-05", ring: "R6", label: "R6-Srv05", weight: 1, plane: "shared", leaf_role: "n/a", trust_tier: "tenant", failure_domain_role: "n/a", metadata: { rack: "rack-6" } }
];
 ...
 *     trust_tier, failure_domain_role, metadata.  No ad-hoc fields added.
